...
namespace Sonic_Delivery_RCP
{
    class Delivery_RCP
    {
        ...
        [FindsBy(How = How.XPath, Using = "//li[text() = 'Shipment - Return Confirmation Pending']")]
        ...
        [FindsBy(How = How.XPath, Using = "//li[text()= 'Address Closed']")]
        ...
        [FindsBy(How = How.XPath, Using = "//div[@id = 'dataTables_info']")]
        public IWebElement BtnFake { get; set; }

        public void DeliveryRCP()
        {
            try
            {
            ...
            try
            {
                ...
                js.ExecuteScript("arguments[0].scrollIntoView();", BtnStatus);
                ...
                doubleclick.DoubleClick(BtnSelectReason).Perform();
                BtnSelectReason.Click();

                //Selected Reason DropDown
                BtnReason.Click();
        ...
        public void Verify()
        {
            ...
            try
            {
                ...
                wait2.Until(ExpectedConditions.ElementToBeClickable(By.XPath("//button[@id = 'statusVerifySubmit']")));
